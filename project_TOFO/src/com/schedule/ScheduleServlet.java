		...
		for(int i=1; i<week; i++) {
			...
			for(ScheduleDTO dto:list) {
				...
				if((dto.getRepeat()==0 && (sd8==cn8 || sd8<=cn8 && ed8>=cn8))
					...
					days[0][i-1]+="<span class='scheduleSubject' data-date='"+s+"' data-num='"+dto.getScheNum()+"' style='background:"+dto.getColor()+";' >"+dto.getTitle()+"</span>";
					cnt++;
		...
		for(row=0; row<days.length; row++) {
			for(int i=week-1; i<7; i++) {
				...
				for(ScheduleDTO dto:list) {
					...
					if((dto.getRepeat()==0 && (sd8==cn8 || sd8<=cn8 && ed8>=cn8))
							|| (dto.getRepeat()==1 && sd4==cn4)) {
						days[row][i]+="<span class='scheduleSubject' data-date='"+s+"' data-num='"+dto.getScheNum()+"' style='background:"+dto.getColor()+";' >"+dto.getTitle()+"</span>";
						cnt++;
					} else if((dto.getRepeat()==0 && (sd8>cn8 && ed8<cn8)) || (dto.getRepeat()==1 && sd4>cn4)){
						break;
					}
